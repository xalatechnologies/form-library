...
import { RadioGroup as RadioGroup$1, FormControlLabel, Radio as Radio$1, Checkbox as Checkbox$1, TextField } from '@mui/material';
import 'react-dom';
...
const MaterialUIRenderer = {
    render: (control, options) => {
        ...
        switch (control.type) {
            case 'text':
            case 'number':
                return (React__default.createElement(TextField, { id: control.id, label: control.label, type: control.type, required: control.required, disabled: control.disabled, defaultValue: control.defaultValue, placeholder: control.placeholder, fullWidth: true }));
            case 'checkbox':
                return (React__default.createElement(FormControlLabel, { control: React__default.createElement(Checkbox$1, { id: control.id, defaultChecked: control.defaultValue, disabled: control.disabled }), label: control.label }));
            case 'radio':
                return (React__default.createElement(RadioGroup$1, { id: control.id, defaultValue: control.defaultValue }, (_a = control.defaultValue) === null || _a === undefined ? undefined : _a.map(option => (React__default.createElement(FormControlLabel, { key: option, value: option, control: React__default.createElement(Radio$1, { disabled: control.disabled }), label: option })))));
            default:
...
var Slot$2 = React.forwardRef((props, forwardedRef) => {
  ...
  if (slottable) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(SlotClone$2, { ...slotProps, ref: forwardedRef, children: React.isValidElement(newElement) ? React.cloneElement(newElement, undefined, newChildren) : null });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(SlotClone$2, { ...slotProps, ref: forwardedRef, children });
});
Slot$2.displayName = "Slot";
var SlotClone$2 = React.forwardRef((props, forwardedRef) => {
  const { children, ...slotProps } = props;
...
function isSlottable$2(child) {
  return React.isValidElement(child) && child.type === Slottable$2;
}
...
var Slot$1 = React.forwardRef((props, forwardedRef) => {
  ...
  if (slottable) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(SlotClone$1, { ...slotProps, ref: forwardedRef, children: React.isValidElement(newElement) ? React.cloneElement(newElement, undefined, newChildren) : null });
  }
...
var Slot = React.forwardRef((props, forwardedRef) => {
  ...
  if (slottable) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(SlotClone, { ...slotProps, ref: forwardedRef, children: React.isValidElement(newElement) ? React.cloneElement(newElement, undefined, newChildren) : null });
  }
...
var DirectionContext = React.createContext(undefined);
...
const ShadcnRenderer = {
    render: (control, options) => {
        ...
        switch (control.type) {
            case 'text':
            case 'number':
                return (React__default.createElement("div", { className: "space-y-2" },
                    React__default.createElement(Label, { htmlFor: control.id }, control.label),
                    React__default.createElement("input", { id: control.id, type: control.type, required: control.required, disabled: control.disabled, defaultValue: control.defaultValue, placeholder: control.placeholder, className: "flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50" })));
            case 'checkbox':
                return (React__default.createElement("div", { className: "flex items-center space-x-2" },
                    React__default.createElement(Checkbox, { id: control.id, defaultChecked: control.defaultValue, disabled: control.disabled }),
                    React__default.createElement(Label, { htmlFor: control.id }, control.label)));
            case 'radio':
                return (React__default.createElement(RadioGroup, { defaultValue: control.defaultValue }, (_a = control.defaultValue) === null || _a === undefined ? undefined : _a.map(option => (React__default.createElement("div", { key: option, className: "flex items-center space-x-2" },
                    React__default.createElement(RadioGroupItem, { value: option, id: `${control.id}-${option}`, disabled: control.disabled }),
                    React__default.createElement(Label, { htmlFor: `${control.id}-${option}` }, option))))));
            default:
                return React__default.createElement("div", null,
                    "Unsupported control type: ",
                    control.type);
...
export { MaterialUIRenderer, ShadcnRenderer };
